...
Workflow:
nips_9d - Generates data
curate.py - Converts data to .pt
run_train.slurm - runs train_9d.py using the config in train_config_9d.py
dense_slice.jl - generates dense data for ground truth image
vis_9d.py - generates plot and png comparing ground truth to predicted
